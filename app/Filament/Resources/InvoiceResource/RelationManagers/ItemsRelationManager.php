    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('code')->placeholder('—')->toggleable(),
                Tables\Columns\TextColumn::make('quantity')->alignEnd(),
                Tables\Columns\TextColumn::make('unit_price')->money('USD')->alignEnd(),
                Tables\Columns\TextColumn::make('total')->money('USD')->alignEnd()->weight('medium'),
            ])
            ->headerActions([
            ...
            ->emptyStateDescription('Add services or charges for this invoice.');
    }
